                        ...
                        @can('guest-user')
                            <div class="row">
                                <label for="last_name" class="col-md-4 col-form-label text-md-right">{{ __('姓') }}</label>
                                    <div class="col-md-6">
                                    <p class="form-control">{{ Auth::user()->last_name }}</p>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <label for="first_name" class="col-md-4 col-form-label text-md-right">{{ __('名') }}</label>
                                    <div class="col-md-6">
                                    <p class="form-control">{{ Auth::user()->first_name }}</p>
                                </div>
                            </div>

                            <div class="row">
                                <label for="first_name" class="col-md-4 col-form-label text-md-right">{{ __('メールアドレス') }}</label>
                                    <div class="col-md-6">
