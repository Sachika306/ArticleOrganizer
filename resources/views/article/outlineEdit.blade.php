          ...
          <div class="card-body">
            <div class="form-group mb-4">
                ...
                <div class="d-flex d-inline-block mb-2">
                    <input type="text" class="form-control {{ $errors->has('lead_title') ? ' is-invalid' : '' }} col-10" id="lead_title" name="lead_title" value="{{ $article->outline->lead_title }}">
                        ...
                        @endif
                    <input type="number" name="lead_chars" class="form-control col-1 ml-2 txtCal {{ $errors->has('lead_chars') ? ' is-invalid' : '' }}"  value="{{ $article->outline->lead_chars }}">
                    <p class="m-1">文字</p>
            ...
            <div class="form-group mb-4">
                ...
                <div class="d-flex d-inline-block mb-2">
                    <input type="text" class="form-control {{ $errors->has('part1_title') ? ' is-invalid' : '' }} col-10" id="part1_title" name="part1_title" value="{{ $article->outline->part1_title }}">
                        ...
                        @endif
                    <input type="number" class="form-control col-1 ml-2 txtCal {{ $errors->has('part1_chars') ? ' is-invalid' : '' }}" name="part1_chars" value="{{ $article->outline->part1_chars }}">
                    <p class="m-1">文字</p>
            ...
            <div class="form-group mb-4">
                ...
                <div class="d-flex d-inline-block mb-2">
                    <input type="text" class="form-control {{ $errors->has('part2_title') ? ' is-invalid' : '' }} col-10" id="part2_title" name="part2_title" value="{{ $article->outline->part2_title }}">
                        ...
                        @endif
                    <input type="number" class="form-control col-1 ml-2 txtCal {{ $errors->has('part2_chars') ? ' is-invalid' : '' }}" name="part2_chars" value="{{ $article->outline->part2_chars }}">
                    <p class="m-1">文字</p>
            ...
            <div class="form-group mb-4">
                ...
                <div class="d-flex d-inline-block mb-2">
                    <input type="text" class="form-control {{ $errors->has('part3_title') ? ' is-invalid' : '' }} col-10" id="part3_title" name="part3_title" value="{{ $article->outline->part3_title }}">
                        ...
                        @endif
                    <input type="number" class="form-control col-1 ml-2 txtCal {{ $errors->has('part3_chars') ? ' is-invalid' : '' }}"  name="part3_chars" value="{{ $article->outline->part3_chars }}">
                        <p class="m-1">文字</p>
            ...
            <div class="form-group mb-4">
                ...
                <input type="text" class="form-control {{ $errors->has('conclusion_title') ? ' is-invalid' : '' }} col-10" id="conclusion_title" name="conclusion_title" value="{{ $article->outline->conclusion_title }}">
                      <input type="number" class="form-control col-1 ml-2 txtCal {{ $errors->has('conclusion_chars') ? ' is-invalid' : '' }}" name="conclusion_chars" value="{{ $article->outline->conclusion_chars }}">
                      <p class="m-1">文字</p>
            ...
            <div class="form-group d-flex d-inline-block mb-2">
                <p class="m-1">合計文字数：</p>
                <input type="number" name="total_chars" class="form-control col-1 ml-2 totalchars {{ $errors->has('total_chars') ? ' is-invalid' : '' }}" value="{{ $article->outline->total_chars }}" readonly>
            </div>
          </div>
