        ...
        <div class="card-body">
          ...
          <div class="mb-5">
            ...
            <div class="form-group">
              <img style="max-height: 500px; max-width: 100%; object-fit: cover; object-position: center; max-width: 100%; border-radius: 0.25rem; border: 1px solid #ced4da;" src="{{ $s3path.$article->thumbnail->file_name }}"> 
            </div>
            @else 
