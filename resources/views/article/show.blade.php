        ...
        <div class="card-body">
          ...
          <div class="mb-5">
            ...
            <div class="form-group">
              <img style="max-height: 500px; max-width: 100%; object-fit: cover; object-position: center; max-width: 100%; border-radius: 0.25rem; border: 1px solid #ced4da;" src="{{ Storage::url($article->thumbnail->file_name) }}"> 
            </div>
            @else 
          ...
          <div class="mb-5">
            ...
            <div class="form-control" style="height:auto;">
             {{ $article->outline->persona }}
            <p><a href="/article/outline/{{ $article->id }}">アウトラインプレビュー</a></p>
            </div>
          </div>
            ...
            <h3 class="display-6">担当者</h3>
                <form method="post" action="/article/reassign/{{ $article->id }}" class="">
                  ...
                  <div class="d-sm-flex mb-2">
                      ...
                      <p class="form-control">{{ $users->find($article->outlineassignment->outline_user_id)->name }} </p>
                      @else 
                  ...
                  <div class="d-sm-flex mb-2">
                      ...
                      @if ($article->status_id == 8)
                      <p class="form-control">{{ $users->find($article->articleassignment->article_user_id)->name }} </p>
                      @else 
